        ...
        <div className={styles.aboutPage}>
                ...
                <div className={styles.proffGrid}>
                    ...
                    <div>
                        ...
                        <ul className={styles.list}>
                            ...
                            <li>более углубленного самопознания;
                                духовного развития;</li>
                            <li>духовного развития;</li>
                            ...
                            <li>развития осознанности и эмоциональной саморегуляции;</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section className={`${styles.section} ${styles.educ}`} id="education">
                ...
                <p>
                    ...
                    Европейской Ассоциации Гештальт-терапии. Теория и практика гештальт терапии\БГ <br/>
                    Курсы психиатрии и психопатологии\Отношенческий транзактный анализ\Аналитическая психология <br/>
                    Юнга\Основы соматологии и психосоматики\Работа с зависимостью\Работа с горем и потерей\Психотерапия для нарцисса
                    -часы личной терапии, семинаров и профессиональных конференций, супервизий, множество часов клинической практики и ведения учебно -терапевтических групповых занятий
            ...
            <section className={styles.section}>
                ...
                <ul className={styles.list}>
                    <li>...это мой клинический опыт, профессиональные навыки, усвоенный этический кодекс ,опора на качественное профессиональное обучение , приверженность профессиональному сообществу.</li>
            ...
            <section className={`${styles.section} ${styles.vector}`}>
                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.text}>
                        <p>... это поиск целостности и основ духовности, прежде всего.
                            Я нахожу очень важным в исследовании состояния человека и всего спектра его переживаний учитывать все слои и уровни сознания. И подходить не только на индивидуально-психологическом, социальном уровне, но и психодуховном, развивать себя «на всех этажах».
                            ...
                            Проблемы психодуховного аспекта, к сожалению, не рассматриваются на должном уровне.В самой психологии эти вопросы относятся к наименее исследованным или ненаучным и поэтому , к сожалению, не требующим рассмотрения. Существует целая обширная область, включающая траснперсональный опыт, духовные прозрения, духовные кризисы, необычные состояния, трансцендентные переживания, которые влияют на психологическое состояние человека, выражаются иногда в кратких психотических эпизодах, временном состоянии дезориентации. В клинической психиатрии принято относить непонятный опыт к психическим расстройствам.

                            Многие люди страдают от невозможности поделиться пугающим опытом и замыкаются.
                            Мой личный опыт заставил меня обратиться к поиску многочисленных вопросов,встающих на этом пути и мне глубоко интересно такое направление в психологии, как трансперсональная, ,основателями которого вступали известные философы и психологии того времени как У Джеймс,КГ Юнг, Р Ассаджиоли,А Маслоу,К Уилбер и другие и которая,к сожалению, до сих пор не имеет научного признания.
