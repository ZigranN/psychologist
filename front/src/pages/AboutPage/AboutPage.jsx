    ...
    return (
        <div className={styles.aboutPage}>
            ...
            <section className={styles.section}>
                ...
                <ul className={styles.list}>
                    <li>... это мой клинический опыт, профессиональные навыки, усвоенный этический кодекс ,опора на качественное профессиональное обучение</li>
                    <li>...это также мой собственный опыт проживания травматических переживаний, проблемных паттернов, над которыми я работала и продолжаю работать.</li>
                    <li>... это бесконечный путь духовного развития и становления собой.</li>
                </ul>
